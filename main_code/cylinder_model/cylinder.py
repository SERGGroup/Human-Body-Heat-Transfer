...
class Cylinder:
    ...
    def Q_irr(self):
        return self.coefficients.sigma*self.geometry.calculate_area()*self.coefficients.epsilon_skin*self.coefficients.f_cl*(self.T_int**4-self.environmental_conditions.temperature**4)  #[W]
    ...
    def energy_balance(self, delta_t, max_steps=1000):  # M - W = Q_cond + Q_conv + Q_irr
        ...
        self.T_int += (balance * delta_t) / (self.body.weight * self.coefficients.cp_skin)
        return self.T_int
